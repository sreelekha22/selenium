...
public class TC_22 {
	...
	public static void main(String[] args) throws Exception {
		...
		WebElement go = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(@class,'fBody')]//input[contains(@name,'go')]")));
		go.click();
		Thread.sleep(3000);
		System.out.println("'Todays leads' view should have been the default view and that view's displayed.");
	}
