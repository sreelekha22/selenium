...
public class TC_27 {
	...
	public static void main(String[] args) throws Exception {
		...
		WebElement dropdown = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@id='hotlist_mode']")));
		dropdown.click();
		WebElement recenlyCreated = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//option[contains(text(),'Recently Created')]")));
		recenlyCreated.click();
		Thread.sleep(2000);
		System.out.println("recenly created contacts is displayed.");
	}
