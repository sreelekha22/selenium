...
public class TC_31 {
	...
	public static void main(String[] args) throws Exception {
		...
		ViewUniqueName.sendKeys("EFGHI");
		
		WebElement save = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='pbHeader']//input[@name='cancel']")));
		save.click();
		Thread.sleep(2000);
		System.out.println("contact home is displayed.Contact is not created.");
	}
